                     ...
                     <div>
                        ...
                        <table className="w-full min-w-[700px] text-left border-collapse hidden md:table">
                           ...
                           <tbody className="divide-y divide-[var(--border-color)]/30">
                              {doctors.map(doc => {
                                 const turnos = stats.currentPeriodApps.filter(a => a.doctorId === doc.id && (a.attendance === 'confirmado' || a.attendance === 'finalizado' || a.attendance === 'en_espera' || a.attendance === 'en_curso' || a.paymentStatus === 'pagado' || a.paymentStatus === 'señado')).length;
